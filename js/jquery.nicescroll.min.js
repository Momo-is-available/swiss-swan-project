/* jquery.nicescroll 3.6.8 InuYaksa*2015 MIT http://nicescroll.areaaperta.com */ (function (
    ...
    var x = window.MutationObserver || window.WebKitMutationObserver || !1,
        ...
        R = function () {
            ...
            d.isie9 =
                d.isie && "performance" in window && 9 == document.documentMode;
            d.isie10 =
                d.isie &&
                "performance" in window &&
                10 == document.documentMode;
            d.isie11 =
                "msRequestFullscreen" in f && 11 <= document.documentMode;
        ...
        S = function (h, c) {
            ...
            function q(b, g, u, c) {
                a._bind(
                    ...
                    function (a) {
                        ...
                        "mousewheel" == g
                            ? (a.wheelDeltaX &&
                                  (c.deltaX = -0.025 * a.wheelDeltaX),
                              a.wheelDeltaY &&
                                  (c.deltaY = -0.025 * a.wheelDeltaY),
                              c.deltaY ||
                                  c.deltaX ||
            ...
            function t(b, g, c) {
                ...
                0 == b.deltaMode
                    ? ((d = -Math.floor(
                          (a.opt.mousescrollstep / 54) * b.deltaX
                      )),
                      (e = -Math.floor(
                          (a.opt.mousescrollstep / 54) * b.deltaY
                      )))
                    : 1 == b.deltaMode &&
            ...
            this.docscroll =
                this.ispage && !this.haswrapper ? f(window) : this.win;
            this.body = f("body");
            ...
            this.init = function () {
                ...
                if (
                    !a.ispage ||
                    (!e.cantouch && !e.isieold && !e.isie9mobile)
                ) {
                    var c = a.docscroll;
                    ...
                    a.ispage
                        ...
                        : (a.ishwscroll
                              ...
                              : ((a.isfixed = "fixed" == a.win.css("position")),
                                ...
                                a.railh &&
                                    (n.css({ position: c }), a.body.append(n))),
                          e.isios &&
                              a.css(a.win, {
                    ...
                    !1 === a.opt.autohidemode
                        ? ((a.autohidedom = !1),
                          ...
                          a.railh &&
                              a.railh.css({ opacity: a.opt.cursoropacitymax }))
                        : !0 === a.opt.autohidemode ||
                          "leave" === a.opt.autohidemode
                    ...
                    if (e.isie9mobile)
                        ...
                        a.onmousedown = function (b, c) {
                            if (!a.rail.drag || 1 == a.rail.drag.pt) {
                                ...
                                a.isiframe &&
                                    !e.hasmousecapture &&
                                    ((a.saved.csspointerevents =
                                        a.doc.css("pointer-events")),
                ...
                if ("IFRAME" == this.doc[0].nodeName) {
                    var N = function () {
                        ...
                        a.opt.enablemousewheel &&
                            a.mousewheel(c, a.onmousewheel);
                        a.opt.enablekeyboard &&
                            a.bind(
                                c,
                                e.isopera ? "keypress" : "keydown",
                                a.onkeypress
                            );
                        if (e.cantouch || a.opt.touchbehavior)
                        ...
                        a.zoom &&
                            (a.opt.dblclickzoom &&
                                a.bind(c, "dblclick", a.doZoom),
                            a.ongesturezoom &&
                                a.bind(c, "gestureend", a.ongesturezoom));
                    };
            ...
            this.showCursor = function (b, c) {
                ...
                if (a.rail) {
                    a.autohidedom &&
                        (a.autohidedom
                            .stop()
                            .css({ opacity: a.opt.cursoropacitymax }),
                        (a.cursoractive = !0));
                    ...
                    a.zoom &&
                        a.zoom.stop().css({ opacity: a.opt.cursoropacitymax });
                }
            };
            ...
            this.onmousewheel = function (b) {
                if (!a.wheelprevented) {
                    ...
                    if (
                        ...
                        return a.railh && a.railh.scrollable
                            ? a.onmousewheelhr(b)
                            : !0;
                    var c = +new Date(),
                        d = !1;
                  ...
                  a.opt.smoothscroll
                    ? ((this.prepareTransition = function (b, c) {
                      ...
                      (this.onScrollTransitionEnd = function () {
                          ...
                          0 > b
                              ? (b = 0)
                              : b > a.page.maxh && (b = a.page.maxh);
                          0 > c
                              ? (c = 0)
                              : c > a.page.maxw && (c = a.page.maxw);
                    ...
                    : ((this.doScrollLeft = function (b, c) {
                      ...
                      (this.doScrollPos = function (b, c, d) {
                          ...
                          var h = Math.round(
                              Math.sqrt(
                                  Math.pow(a.dst.x, 2) + Math.pow(a.dst.y, 2)
                              )
                          );
                          a.dst.ax = a.dst.x / h;
                          a.dst.ay = a.dst.y / h;
            ...
            this.doScrollBy = function (b, c) {
                ...
                if (a.bouncescroll) {
                    ...
                    d < -e
                        ? (d = -e)
                        : d > a.page.maxh + e && (d = a.page.maxh + e);
                }
                a.cursorfreezed = !1;
                e = a.getScrollTop(!0);
            ...
            this.doScrollLeftBy = function (b, c) {
                ...
                if (a.bouncescroll) {
                    ...
                    d < -e
                        ? (d = -e)
                        : d > a.page.maxw + e && (d = a.page.maxw + e);
                }
                a.cursorfreezed = !1;
                e = a.getScrollLeft(!0);
            ...
            this.doZoomOut = function (b) {
                if (a.zoomactive)
                    return (
                        ...
                        e.isios4 &&
                            f(window).scrollTop(a.zoomrestore.scrollTop),
            ...
            this.resizeZoom = function () {
                if (a.zoomactive) {
                    ...
                    a.win.css({
                        width:
                            f(window).width() - a.zoomrestore.padding.w + "px",
                        height:
